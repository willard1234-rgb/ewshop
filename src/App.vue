<template>
  ...
  <div id="nav">
    <router-link class="tab-bar-item" to="/">
      <div class="icon"><i class="iconfont icon-shouye-01"></i></div>
      <div>首页</div>
    </router-link>
    <router-link class="tab-bar-item" to="/categroy">
      <div class="icon">
        <i class="iconfont icon-biaoqiankuozhan_fenlei-127"></i>
      </div>
      <div>分类</div>
    </router-link>
    ...
    <router-link class="tab-bar-item" to="/profile">
      <div class="icon"><i class="iconfont icon-yiliaohangyedeICON-"></i></div>
      <div>我的</div>
    </router-link>
  </div>
</template>
